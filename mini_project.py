...
st.markdown("""
    <div style='border: 1px solid black; padding: 10px; border-radius: 5px; background-color: #F9F9F9;'>
        Visualization นี้แสดงถึงประสิทธิภาพของแบบจำลองที่ใช้ระบุและจัดประเภทคำหรือวลีในข้อความที่เกี่ยวข้องกับชื่อ - นามสกุลและที่อยู่ในหลากหลายรูปแบบ<br>
        โดยให้เลือกรูปแบบการใส่ที่อยู่ในแบบต่างๆ เพื่อดูประสิทธิภาพของแบบจำลองดังนี้<br>
        เลือกจังหวัดที่อยากทราบประสิทธิภาพของแบบจำลอง
    </div>
